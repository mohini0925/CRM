           ...
           <View style={styles.container}>
            <ScrollView>
             <View style={styles.BtnContainer}>
                 <TouchableOpacity style={styles.ViewBtn} onPress={() => navigation.navigate('viewTicketStack',{screen: 'ViewTicket'})} ><Text style={styles.Viewtext}>View Ticket</Text></TouchableOpacity>
                 <TouchableOpacity style={styles.CreateBtn}  onPress={() => navigation.navigate('createticketStack')}><Text style={styles.Viewtext}>Create Ticket</Text></TouchableOpacity>
             </View>
             <View style={styles.textContainer}>
                 <Text style={styles.ticketText}>
                     Tickets
                 </Text>
             <TouchableOpacity onPress={() => navigation.navigate('viewTicketStack')}><Text style={styles.moreText}>More</Text></TouchableOpacity>  
             </View>
             <View>
